      ...
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gdiStagingApp.isoCountryCode.home.createOrEditLabel" data-cy="IsoCountryCodeCreateUpdateHeading">
            <Translate contentKey="gdiStagingApp.isoCountryCode.home.createOrEditLabel">Create or edit a IsoCountryCode</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gdiStagingApp.isoCountryCode.countryCode')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.isoCountryCode.countryDescription')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.isoCountryCode.placeholder')}
