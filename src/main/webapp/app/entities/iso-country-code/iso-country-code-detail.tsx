    ...
    <Row>
      <Col md="8">
        <h2 data-cy="isoCountryCodeDetailsHeading">
          <Translate contentKey="gdiStagingApp.isoCountryCode.detail.title">IsoCountryCode</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="countryCode">
              <Translate contentKey="gdiStagingApp.isoCountryCode.countryCode">Country Code</Translate>
            </span>
          </dt>
          <dd>{isoCountryCodeEntity.countryCode}</dd>
          <dt>
            <span id="countryDescription">
              <Translate contentKey="gdiStagingApp.isoCountryCode.countryDescription">Country Description</Translate>
            </span>
          </dt>
          <dd>{isoCountryCodeEntity.countryDescription}</dd>
          <dt>
            <Translate contentKey="gdiStagingApp.isoCountryCode.placeholder">Placeholder</Translate>
          </dt>
          <dd>
