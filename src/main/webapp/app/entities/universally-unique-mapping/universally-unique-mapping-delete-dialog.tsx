...
export const UniversallyUniqueMappingDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gdiStagingApp.universallyUniqueMapping.delete.question">
        <Translate
          contentKey="gdiStagingApp.universallyUniqueMapping.delete.question"
          interpolate={{ id: universallyUniqueMappingEntity.id }}
        >
          Are you sure you want to delete this UniversallyUniqueMapping?
        </Translate>
      </ModalBody>
      <ModalFooter>
