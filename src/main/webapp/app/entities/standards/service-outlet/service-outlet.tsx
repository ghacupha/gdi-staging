  ...
  return (
    <div>
      <h2 id="service-outlet-heading" data-cy="ServiceOutletHeading">
        <Translate contentKey="gdiStagingApp.standardsServiceOutlet.home.title">Service Outlets</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gdiStagingApp.standardsServiceOutlet.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/service-outlet/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="gdiStagingApp.standardsServiceOutlet.home.createLabel">Create new Service Outlet</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('gdiStagingApp.standardsServiceOutlet.home.search')}
                />
          ...
          {serviceOutletList && serviceOutletList.length > 0 ? (
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="gdiStagingApp.standardsServiceOutlet.id">ID</Translate>{' '}
                    <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                  </th>
                  <th className="hand" onClick={sort('outletCode')}>
                    <Translate contentKey="gdiStagingApp.standardsServiceOutlet.outletCode">Outlet Code</Translate>{' '}
                    <FontAwesomeIcon icon={getSortIconByFieldName('outletCode')} />
                  </th>
                  <th className="hand" onClick={sort('outletName')}>
                    <Translate contentKey="gdiStagingApp.standardsServiceOutlet.outletName">Outlet Name</Translate>{' '}
                    <FontAwesomeIcon icon={getSortIconByFieldName('outletName')} />
                  </th>
                  <th className="hand" onClick={sort('town')}>
                    <Translate contentKey="gdiStagingApp.standardsServiceOutlet.town">Town</Translate>{' '}
                    <FontAwesomeIcon icon={getSortIconByFieldName('town')} />
                  </th>
                  <th className="hand" onClick={sort('parliamentaryConstituency')}>
                    <Translate contentKey="gdiStagingApp.standardsServiceOutlet.parliamentaryConstituency">
                      Parliamentary Constituency
                    </Translate>{' '}
                    <FontAwesomeIcon icon={getSortIconByFieldName('parliamentaryConstituency')} />
                  </th>
                  <th className="hand" onClick={sort('gpsCoordinates')}>
                    <Translate contentKey="gdiStagingApp.standardsServiceOutlet.gpsCoordinates">Gps Coordinates</Translate>{' '}
                    <FontAwesomeIcon icon={getSortIconByFieldName('gpsCoordinates')} />
                  </th>
                  <th className="hand" onClick={sort('outletOpeningDate')}>
                    <Translate contentKey="gdiStagingApp.standardsServiceOutlet.outletOpeningDate">Outlet Opening Date</Translate>{' '}
                    <FontAwesomeIcon icon={getSortIconByFieldName('outletOpeningDate')} />
                  </th>
                  <th className="hand" onClick={sort('regulatorApprovalDate')}>
                    <Translate contentKey="gdiStagingApp.standardsServiceOutlet.regulatorApprovalDate">Regulator Approval Date</Translate>{' '}
                    <FontAwesomeIcon icon={getSortIconByFieldName('regulatorApprovalDate')} />
                  </th>
                  <th className="hand" onClick={sort('outletClosureDate')}>
                    <Translate contentKey="gdiStagingApp.standardsServiceOutlet.outletClosureDate">Outlet Closure Date</Translate>{' '}
                    <FontAwesomeIcon icon={getSortIconByFieldName('outletClosureDate')} />
                  </th>
                  <th className="hand" onClick={sort('dateLastModified')}>
                    <Translate contentKey="gdiStagingApp.standardsServiceOutlet.dateLastModified">Date Last Modified</Translate>{' '}
                    <FontAwesomeIcon icon={getSortIconByFieldName('dateLastModified')} />
                  </th>
                  <th className="hand" onClick={sort('licenseFeePayable')}>
                    <Translate contentKey="gdiStagingApp.standardsServiceOutlet.licenseFeePayable">License Fee Payable</Translate>{' '}
                    <FontAwesomeIcon icon={getSortIconByFieldName('licenseFeePayable')} />
                  </th>
                  <th>
                    <Translate contentKey="gdiStagingApp.standardsServiceOutlet.bankCode">Bank Code</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="gdiStagingApp.standardsServiceOutlet.outletType">Outlet Type</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="gdiStagingApp.standardsServiceOutlet.outletStatus">Outlet Status</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="gdiStagingApp.standardsServiceOutlet.countyName">County Name</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="gdiStagingApp.standardsServiceOutlet.subCountyName">Sub County Name</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="gdiStagingApp.standardsServiceOutlet.home.notFound">No Service Outlets found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
