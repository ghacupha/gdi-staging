      ...
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gdiStagingApp.standardsServiceOutlet.home.createOrEditLabel" data-cy="ServiceOutletCreateUpdateHeading">
            <Translate contentKey="gdiStagingApp.standardsServiceOutlet.home.createOrEditLabel">Create or edit a ServiceOutlet</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gdiStagingApp.standardsServiceOutlet.outletCode')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsServiceOutlet.outletName')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsServiceOutlet.town')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsServiceOutlet.parliamentaryConstituency')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsServiceOutlet.gpsCoordinates')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsServiceOutlet.outletOpeningDate')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsServiceOutlet.regulatorApprovalDate')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsServiceOutlet.outletClosureDate')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsServiceOutlet.dateLastModified')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsServiceOutlet.licenseFeePayable')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsServiceOutlet.placeholder')}
              ...
              <ValidatedField
                ...
                name="bankCode"
                data-cy="bankCode"
                label={translate('gdiStagingApp.standardsServiceOutlet.bankCode')}
                type="select"
              >
                <option value="" key="0" />
                {bankBranchCodes
              ...
              <ValidatedField
                ...
                name="outletType"
                data-cy="outletType"
                label={translate('gdiStagingApp.standardsServiceOutlet.outletType')}
                type="select"
              >
                <option value="" key="0" />
                {outletTypes
              ...
              <ValidatedField
                ...
                label={translate('gdiStagingApp.standardsServiceOutlet.outletStatus')}
                type="select"
              >
                <option value="" key="0" />
                {outletStatuses
              ...
              <ValidatedField
                ...
                name="countyName"
                data-cy="countyName"
                label={translate('gdiStagingApp.standardsServiceOutlet.countyName')}
                type="select"
              >
                <option value="" key="0" />
                {countyCodes
              ...
              <ValidatedField
                ...
                label={translate('gdiStagingApp.standardsServiceOutlet.subCountyName')}
                type="select"
              >
                <option value="" key="0" />
                {countyCodes
