    ...
    <Row>
      <Col md="8">
        <h2 data-cy="serviceOutletDetailsHeading">
          <Translate contentKey="gdiStagingApp.standardsServiceOutlet.detail.title">ServiceOutlet</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="parliamentaryConstituency">
              <Translate contentKey="gdiStagingApp.standardsServiceOutlet.parliamentaryConstituency">Parliamentary Constituency</Translate>
            </span>
          </dt>
          ...
          <dt>
            <Translate contentKey="gdiStagingApp.standardsServiceOutlet.placeholder">Placeholder</Translate>
          </dt>
          <dd>
