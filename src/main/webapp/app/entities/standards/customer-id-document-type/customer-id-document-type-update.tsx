      ...
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gdiStagingApp.standardsCustomerIdDocumentType.home.createOrEditLabel" data-cy="CustomerIDDocumentTypeCreateUpdateHeading">
            <Translate contentKey="gdiStagingApp.standardsCustomerIdDocumentType.home.createOrEditLabel">
              Create or edit a CustomerIDDocumentType
            </Translate>
          </h2>
        </Col>
      </Row>
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  required
                  readOnly
                  id="customer-id-document-type-id"
                  label={translate('global.field.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('gdiStagingApp.standardsCustomerIdDocumentType.documentCode')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsCustomerIdDocumentType.documentType')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsCustomerIdDocumentType.documentTypeDescription')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsCustomerIdDocumentType.placeholder')}
