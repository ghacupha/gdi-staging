    ...
    <Row>
      <Col md="8">
        <h2 data-cy="customerIDDocumentTypeDetailsHeading">
          <Translate contentKey="gdiStagingApp.standardsCustomerIdDocumentType.detail.title">CustomerIDDocumentType</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="gdiStagingApp.standardsCustomerIdDocumentType.placeholder">Placeholder</Translate>
          </dt>
          <dd>
