  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gdiStagingApp.standardsOutletType.home.createOrEditLabel" data-cy="OutletTypeCreateUpdateHeading">
            <Translate contentKey="gdiStagingApp.standardsOutletType.home.createOrEditLabel">Create or edit a OutletType</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gdiStagingApp.standardsOutletType.outletTypeCode')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsOutletType.outletType')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsOutletType.outletTypeDetails')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsOutletType.placeholder')}
