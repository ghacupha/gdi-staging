  ...
  return (
    <div>
      <h2 id="bank-branch-code-heading" data-cy="BankBranchCodeHeading">
        <Translate contentKey="gdiStagingApp.standardsBankBranchCode.home.title">Bank Branch Codes</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gdiStagingApp.standardsBankBranchCode.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/bank-branch-code/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="gdiStagingApp.standardsBankBranchCode.home.createLabel">Create new Bank Branch Code</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('gdiStagingApp.standardsBankBranchCode.home.search')}
                />
        ...
        {bankBranchCodeList && bankBranchCodeList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="gdiStagingApp.standardsBankBranchCode.id">ID</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gdiStagingApp.standardsBankBranchCode.home.notFound">No Bank Branch Codes found</Translate>
            </div>
          )
        )}
      </div>
