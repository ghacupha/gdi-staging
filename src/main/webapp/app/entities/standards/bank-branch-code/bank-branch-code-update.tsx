      ...
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gdiStagingApp.standardsBankBranchCode.home.createOrEditLabel" data-cy="BankBranchCodeCreateUpdateHeading">
            <Translate contentKey="gdiStagingApp.standardsBankBranchCode.home.createOrEditLabel">Create or edit a BankBranchCode</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gdiStagingApp.standardsBankBranchCode.bankCode')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsBankBranchCode.bankName')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsBankBranchCode.branchCode')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsBankBranchCode.branchName')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsBankBranchCode.notes')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsBankBranchCode.placeholder')}
