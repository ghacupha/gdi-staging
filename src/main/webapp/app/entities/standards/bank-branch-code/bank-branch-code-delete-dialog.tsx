...
export const BankBranchCodeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gdiStagingApp.standardsBankBranchCode.delete.question">
        <Translate contentKey="gdiStagingApp.standardsBankBranchCode.delete.question" interpolate={{ id: bankBranchCodeEntity.id }}>
