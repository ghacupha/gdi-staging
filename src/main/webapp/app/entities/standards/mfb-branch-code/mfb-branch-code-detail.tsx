    ...
    <Row>
      <Col md="8">
        <h2 data-cy="mfbBranchCodeDetailsHeading">
          <Translate contentKey="gdiStagingApp.standardsMfbBranchCode.detail.title">MfbBranchCode</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="bankCode">
              <Translate contentKey="gdiStagingApp.standardsMfbBranchCode.bankCode">Bank Code</Translate>
            </span>
          </dt>
          <dd>{mfbBranchCodeEntity.bankCode}</dd>
          <dt>
            <span id="bankName">
              <Translate contentKey="gdiStagingApp.standardsMfbBranchCode.bankName">Bank Name</Translate>
            </span>
          </dt>
          <dd>{mfbBranchCodeEntity.bankName}</dd>
          <dt>
            <span id="branchCode">
              <Translate contentKey="gdiStagingApp.standardsMfbBranchCode.branchCode">Branch Code</Translate>
            </span>
          </dt>
          <dd>{mfbBranchCodeEntity.branchCode}</dd>
          <dt>
            <span id="branchName">
              <Translate contentKey="gdiStagingApp.standardsMfbBranchCode.branchName">Branch Name</Translate>
            </span>
          </dt>
          <dd>{mfbBranchCodeEntity.branchName}</dd>
          <dt>
            <Translate contentKey="gdiStagingApp.standardsMfbBranchCode.placeholder">Placeholder</Translate>
          </dt>
          <dd>
