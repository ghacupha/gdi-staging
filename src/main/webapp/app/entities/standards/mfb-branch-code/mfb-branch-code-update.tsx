  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gdiStagingApp.standardsMfbBranchCode.home.createOrEditLabel" data-cy="MfbBranchCodeCreateUpdateHeading">
            <Translate contentKey="gdiStagingApp.standardsMfbBranchCode.home.createOrEditLabel">Create or edit a MfbBranchCode</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gdiStagingApp.standardsMfbBranchCode.bankCode')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsMfbBranchCode.bankName')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsMfbBranchCode.branchCode')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsMfbBranchCode.branchName')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsMfbBranchCode.placeholder')}
