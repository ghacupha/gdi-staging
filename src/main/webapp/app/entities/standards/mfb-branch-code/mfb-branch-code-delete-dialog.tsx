...
export const MfbBranchCodeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gdiStagingApp.standardsMfbBranchCode.delete.question">
        <Translate contentKey="gdiStagingApp.standardsMfbBranchCode.delete.question" interpolate={{ id: mfbBranchCodeEntity.id }}>
