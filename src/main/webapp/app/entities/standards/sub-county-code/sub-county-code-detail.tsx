    ...
    <Row>
      <Col md="8">
        <h2 data-cy="subCountyCodeDetailsHeading">
          <Translate contentKey="gdiStagingApp.standardsSubCountyCode.detail.title">SubCountyCode</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="gdiStagingApp.standardsSubCountyCode.placeholder">Placeholder</Translate>
          </dt>
          <dd>
