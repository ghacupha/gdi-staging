...
export const InstitutionCodeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gdiStagingApp.standardsInstitutionCode.delete.question">
        <Translate contentKey="gdiStagingApp.standardsInstitutionCode.delete.question" interpolate={{ id: institutionCodeEntity.id }}>
          Are you sure you want to delete this InstitutionCode?
        </Translate>
      </ModalBody>
      <ModalFooter>
