  ...
  return (
    <div>
      <h2 id="county-code-heading" data-cy="CountyCodeHeading">
        <Translate contentKey="gdiStagingApp.standardsCountyCode.home.title">County Codes</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gdiStagingApp.standardsCountyCode.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/county-code/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gdiStagingApp.standardsCountyCode.home.createLabel">Create new County Code</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('gdiStagingApp.standardsCountyCode.home.search')}
                />
          ...
          {countyCodeList && countyCodeList.length > 0 ? (
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="gdiStagingApp.standardsCountyCode.id">ID</Translate>{' '}
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="gdiStagingApp.standardsCountyCode.home.notFound">No County Codes found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
