  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gdiStagingApp.standardsCountyCode.home.createOrEditLabel" data-cy="CountyCodeCreateUpdateHeading">
            <Translate contentKey="gdiStagingApp.standardsCountyCode.home.createOrEditLabel">Create or edit a CountyCode</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gdiStagingApp.standardsCountyCode.countyCode')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsCountyCode.countyName')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsCountyCode.subCountyCode')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsCountyCode.subCountyName')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.standardsCountyCode.placeholder')}
