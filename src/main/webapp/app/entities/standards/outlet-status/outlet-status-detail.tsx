    ...
    <Row>
      <Col md="8">
        <h2 data-cy="outletStatusDetailsHeading">
          <Translate contentKey="gdiStagingApp.standardsOutletStatus.detail.title">OutletStatus</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="gdiStagingApp.standardsOutletStatus.placeholder">Placeholder</Translate>
          </dt>
          <dd>
