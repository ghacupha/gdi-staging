    ...
    <Row>
      <Col md="8">
        <h2 data-cy="outletTypeDetailsHeading">
          <Translate contentKey="gdiStagingApp.outletType.detail.title">OutletType</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="gdiStagingApp.outletType.placeholder">Placeholder</Translate>
          </dt>
          <dd>
