    ...
    <Row>
      <Col md="8">
        <h2 data-cy="universallyUniqueMappingDetailsHeading">
          <Translate contentKey="gdiStagingApp.serviceUniversallyUniqueMapping.detail.title">UniversallyUniqueMapping</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="gdiStagingApp.serviceUniversallyUniqueMapping.placeholder">Placeholder</Translate>
          </dt>
          <dd>
