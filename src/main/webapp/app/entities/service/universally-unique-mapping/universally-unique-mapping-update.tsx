    ...
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          ...
          >
            <Translate contentKey="gdiStagingApp.serviceUniversallyUniqueMapping.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gdiStagingApp.serviceUniversallyUniqueMapping.universalKey')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.serviceUniversallyUniqueMapping.mappedValue')}
              ...
              <ValidatedField
                ...
                label={translate('gdiStagingApp.serviceUniversallyUniqueMapping.parentMapping')}
                type="select"
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                label={translate('gdiStagingApp.serviceUniversallyUniqueMapping.placeholder')}
