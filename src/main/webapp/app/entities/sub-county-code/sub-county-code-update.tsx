      ...
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gdiStagingApp.subCountyCode.home.createOrEditLabel" data-cy="SubCountyCodeCreateUpdateHeading">
            <Translate contentKey="gdiStagingApp.subCountyCode.home.createOrEditLabel">Create or edit a SubCountyCode</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gdiStagingApp.subCountyCode.countyCode')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.subCountyCode.countyName')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.subCountyCode.subCountyCode')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.subCountyCode.subCountyName')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.subCountyCode.placeholder')}
