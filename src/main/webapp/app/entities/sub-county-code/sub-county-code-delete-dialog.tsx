...
export const SubCountyCodeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gdiStagingApp.subCountyCode.delete.question">
        <Translate contentKey="gdiStagingApp.subCountyCode.delete.question" interpolate={{ id: subCountyCodeEntity.id }}>
