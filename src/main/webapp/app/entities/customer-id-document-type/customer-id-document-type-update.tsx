      ...
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gdiStagingApp.customerIDDocumentType.home.createOrEditLabel" data-cy="CustomerIDDocumentTypeCreateUpdateHeading">
            <Translate contentKey="gdiStagingApp.customerIDDocumentType.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gdiStagingApp.customerIDDocumentType.documentCode')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.customerIDDocumentType.documentType')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.customerIDDocumentType.documentTypeDescription')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.customerIDDocumentType.placeholder')}
