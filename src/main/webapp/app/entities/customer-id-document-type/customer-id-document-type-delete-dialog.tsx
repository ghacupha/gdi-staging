...
export const CustomerIDDocumentTypeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gdiStagingApp.customerIDDocumentType.delete.question">
        <Translate contentKey="gdiStagingApp.customerIDDocumentType.delete.question" interpolate={{ id: customerIDDocumentTypeEntity.id }}>
          Are you sure you want to delete this CustomerIDDocumentType?
        </Translate>
      </ModalBody>
      <ModalFooter>
