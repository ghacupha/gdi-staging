      ...
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gdiStagingApp.outletStatus.home.createOrEditLabel" data-cy="OutletStatusCreateUpdateHeading">
            <Translate contentKey="gdiStagingApp.outletStatus.home.createOrEditLabel">Create or edit a OutletStatus</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gdiStagingApp.outletStatus.branchStatusTypeCode')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.outletStatus.branchStatusType')}
              ...
              <ValidatedField
                label={translate('gdiStagingApp.outletStatus.branchStatusTypeDescription')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.outletStatus.placeholder')}
