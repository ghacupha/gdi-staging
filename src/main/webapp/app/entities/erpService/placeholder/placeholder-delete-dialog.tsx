...
export const PlaceholderDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gdiStagingApp.erpServicePlaceholder.delete.question">
        <Translate contentKey="gdiStagingApp.erpServicePlaceholder.delete.question" interpolate={{ id: placeholderEntity.id }}>
