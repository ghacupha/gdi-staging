    ...
    <Row>
      <Col md="8">
        <h2 data-cy="bankBranchCodeDetailsHeading">
          <Translate contentKey="gdiStagingApp.bankBranchCode.detail.title">BankBranchCode</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="gdiStagingApp.bankBranchCode.placeholder">Placeholder</Translate>
          </dt>
          <dd>
