      ...
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gdiStagingApp.outletType.home.createOrEditLabel" data-cy="OutletTypeCreateUpdateHeading">
            <Translate contentKey="gdiStagingApp.outletType.home.createOrEditLabel">Create or edit a OutletType</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gdiStagingApp.outletType.outletTypeCode')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.outletType.outletType')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.outletType.outletTypeDetails')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.outletType.placeholder')}
