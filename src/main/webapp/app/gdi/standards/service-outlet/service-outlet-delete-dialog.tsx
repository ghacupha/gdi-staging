...
export const ServiceOutletDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gdiStagingApp.serviceOutlet.delete.question">
        <Translate contentKey="gdiStagingApp.serviceOutlet.delete.question" interpolate={{ id: serviceOutletEntity.id }}>
