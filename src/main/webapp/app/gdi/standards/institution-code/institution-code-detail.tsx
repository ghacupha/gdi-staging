    ...
    <Row>
      <Col md="8">
        <h2 data-cy="institutionCodeDetailsHeading">
          <Translate contentKey="gdiStagingApp.institutionCode.detail.title">InstitutionCode</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="gdiStagingApp.institutionCode.placeholder">Placeholder</Translate>
          </dt>
          <dd>
