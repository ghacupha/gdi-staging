      ...
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gdiStagingApp.institutionCode.home.createOrEditLabel" data-cy="InstitutionCodeCreateUpdateHeading">
            <Translate contentKey="gdiStagingApp.institutionCode.home.createOrEditLabel">Create or edit a InstitutionCode</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gdiStagingApp.institutionCode.institutionCode')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.institutionCode.institutionName')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.institutionCode.shortName')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.institutionCode.category')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.institutionCode.institutionCategory')}
              ...
              />
              <ValidatedField
                label={translate('gdiStagingApp.institutionCode.placeholder')}
