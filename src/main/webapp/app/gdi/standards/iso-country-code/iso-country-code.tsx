  ...
  return (
    <div>
      <h2 id="iso-country-code-heading" data-cy="IsoCountryCodeHeading">
        <Translate contentKey="gdiStagingApp.isoCountryCode.home.title">Iso Country Codes</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gdiStagingApp.isoCountryCode.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/iso-country-code/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="gdiStagingApp.isoCountryCode.home.createLabel">Create new Iso Country Code</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('gdiStagingApp.isoCountryCode.home.search')}
                />
          ...
          {isoCountryCodeList && isoCountryCodeList.length > 0 ? (
              ...
              <thead>
                <tr>
                  <th className="hand" onClick={sort('id')}>
                    <Translate contentKey="gdiStagingApp.isoCountryCode.id">ID</Translate>{' '}
            ...
            !loading && (
              <div className="alert alert-warning">
                <Translate contentKey="gdiStagingApp.isoCountryCode.home.notFound">No Iso Country Codes found</Translate>
              </div>
            )
          )}
        </InfiniteScroll>
