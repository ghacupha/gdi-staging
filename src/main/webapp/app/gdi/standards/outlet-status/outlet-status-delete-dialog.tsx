...
export const OutletStatusDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gdiStagingApp.outletStatus.delete.question">
        <Translate contentKey="gdiStagingApp.outletStatus.delete.question" interpolate={{ id: outletStatusEntity.id }}>
