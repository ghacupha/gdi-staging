    ...
    <Row>
      <Col md="8">
        <h2 data-cy="countyCodeDetailsHeading">
          <Translate contentKey="gdiStagingApp.countyCode.detail.title">CountyCode</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="gdiStagingApp.countyCode.placeholder">Placeholder</Translate>
          </dt>
          <dd>
