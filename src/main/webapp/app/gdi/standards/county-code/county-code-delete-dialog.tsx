...
export const CountyCodeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gdiStagingApp.countyCode.delete.question">
        <Translate contentKey="gdiStagingApp.countyCode.delete.question" interpolate={{ id: countyCodeEntity.id }}>
          Are you sure you want to delete this CountyCode?
        </Translate>
      </ModalBody>
      <ModalFooter>
